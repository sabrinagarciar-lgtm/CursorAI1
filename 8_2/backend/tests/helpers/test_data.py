"""Test data generation strategy for ShopEase API tests.
...
# --- Auth credentials (mirror seeded users in app/db.py) ---
...
def build_product_payload(
    *,
    title: str = "API Test Gadget",
    description: str = "Created by API test suite.",
    price: float = 19.99,
    image_url: str = "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400",
...
def build_order_payload(
    *,
    ...
    customer_email: str = "api.tester@example.com",
    status: str = "pending",
) -> dict[str, Any]:
    pid = product_id or PRODUCT_IDS["mug"]
    return {
        "customer_name": customer_name,
        "customer_email": customer_email,
        "status": status,
        "items": build_cart_items((pid, quantity)),
    }
