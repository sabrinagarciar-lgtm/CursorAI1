...
CRA rows link to the **main app README** inside the nested folder (`exerciseN/exerciseN/README.md`). Full-stack projects (7.2, 8.1, 8.2) are at the repo root. See [**CI performance summary →**](8_1_ecommerce/docs/CI_PERFORMANCE.md) for pipeline benchmarks.
